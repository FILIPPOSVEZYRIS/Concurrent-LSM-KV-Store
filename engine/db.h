...
//    char basedir[MAX_FILENAME];
    ...
    SST* sst;
    MemTable* memtable;
    //pthread_mutex_t my_lock; //mutex variable declaration
    
    pthread_mutex_t rw_lock;  //protection for the counters bellow
    pthread_cond_t readers_cv; //here the readers wait
    pthread_cond_t writers_cv; //here the writers wait
